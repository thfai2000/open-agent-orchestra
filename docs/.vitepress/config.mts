        ...
        '/guide/': [
          {
            ...
            items: [
              ...
              { text: 'Copilot Token Variable Setup', link: '/guide/copilot-token-variable' },
              { text: 'External Integration Workflows', link: '/guide/external-integration-workflows' },
              { text: 'Jira Integration Tutorial', link: '/guide/jira-integration' },
