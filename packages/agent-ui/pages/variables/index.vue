    ...
    <Dialog v-model:open="showCreate">
      <DialogContent class="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>Variables are encrypted at rest. Agent-level variables override user-level keys with the same name.</DialogDescription>
        </DialogHeader>
...
async function handleDelete(id: string, key: string, scope: string) {
  ...
  try {
    const query = scope === 'user' ? '?scope=user' : '';
